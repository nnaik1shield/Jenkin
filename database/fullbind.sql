--
-- fullbind.sql - issues grants and creates synonyms required for Dragon
-- THIS WILL DROP ALL GRANTS AND SYNONYMS, RE-CREATE THEM, AND RE-COMPILE EVERYTHING
--
...
@@pkg_os_grant.sql
PROMPT
PROMPT Re-creating grants for &&MD_USER
PROMPT
SET FEEDBACK OFF
BEGIN
   PKG_OS_GRANT.revoke_all();
--
...
@@pkg_os_grant.sql
PROMPT
PROMPT Re-creating grants and synonyms for &&ST_USER
PROMPT
SET FEEDBACK OFF
BEGIN
   PKG_OS_GRANT.revoke_all();
...
SET PAGES 200
PROMPT
PROMPT Re-creating synonyms for &&MD_USER
PROMPT
SET FEEDBACK OFF
BEGIN
   PKG_OS_GRANT.no_syn();
...
@@pkg_os_grant.sql
PROMPT
PROMPT Creating synonyms for &&API_USER
PROMPT
SET FEEDBACK OFF
BEGIN
   PKG_OS_GRANT.no_syn();
